...
class DEG_Enrichment:
	def DataPreprocess(self):
		infile_list = ['AZM_SERUM_Paper.txt', 'UpRegulated_AZM_Vs_SERUM.txt', 'DownRegulated_AZM_Vs_SERUM.txt', 'PAO1_AMR_Annotations.tsv', 'AZM_SERUM_BiologicalReplicate.txt']
		Format = Data_Processer.AMR_Format(infile_list[0], infile_list[1], infile_list[2], infile_list[3], infile_list[4])
			
		fl_list = ['AZM_SERUM_BiologicalReplicate.txt', 'PAO1_AMR_Annotations.tsv', 'AZM_SERUM_Paper.txt', 'PAO1_Cluster_DEG_BiologicalReplicates.txt']
