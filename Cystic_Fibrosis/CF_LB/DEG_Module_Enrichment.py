...
class DEG_Enrichment:
	def DataPreprocess(self):
		fl_list = ['Input_Files/CF_Vs_LB_Significant.txt', 'Output_Files/PAO1_Cluster_DEG_BiologicalReplicates.txt']
		Cluster = Data_Processer().DEG_Cluster(fl_list[0], fl_list[1])
	
		modclust_list = ['Input_Files/Module_Assignment_PAO1_WGCNA.tsv', 'Output_Files/PAO1_Modules_Clusters.txt', 'Output_Files/WGCNA_PAO1_Modules_Clusters.txt']
		mod_cluster = Data_Processer().Module_Clusters(modclust_list[0], modclust_list[1], modclust_list[2])
	
		clust_modlist = ['Output_Files/PAO1_Cluster_DEG_BiologicalReplicates.txt', 'Input_Files/Module_Assignment_PAO1_WGCNA.tsv', 'Output_Files/PAO1_DEG_Modules.txt', 'Output_Files/PAO1_DEG_Modules.txt', 'Output_Files/PAO1_DEG_Genes_Modules.txt']
