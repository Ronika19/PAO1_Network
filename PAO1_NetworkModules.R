...
cyt = exportNetworkToCytoscape(TOM,edgeFile="PAO1_WGCNA_Edges.txt",nodeFile="PAO1_WGCNA_Nodes.txt",weighted=TRUE,threshold=0.02,nodeNames=colnames(datExpr0))
 
# Save command history
# savehistory(file="PAO1_NetworkModule.Rhistory")
